                    ...
                    <div class="tab-pane fade active show" id="all-app" role="tabpanel" tabindex="0">
                        <div class="card">
                            <div class="card-header d-flex align-items-center">
                                ...
                                <button class="btn btn-warning ms-auto"><a href="./application-clear-approve.php" class="text-decoration-none text-reset" title='Удалить все заявки со статусами "выполнена" и "отменена"'>Почистить архив</a></button>
                            </div>
